...
},success:function(h){h.text("OK!").addClass("valid").closest(".control-group").removeClass("error").addClass("success");}});$("#platos").validate({rules:{va_nombre:{required:true,minlength:3},tx_descripcion:{required:true},va_precio:{required:true},Ta_tipo_plato:{required:true}},messages:{va_nombre:{required:"Por favor ingresar el nombre del plato",minlength:"Minimo 3 caracteres"},tx_descripcion:{required:"Por favor ingresar la descripcion"},va_precio:{required:"Por favor ingrese un precio"},Ta_tipo_plato:{required:"Por favor ingresar un tipo de plato"}},highlight:function(h){$(h).closest(".control-group").removeClass("success").addClass("error");
