...
$(".control-group").removeClass("error");$("label").remove(":contains('OK!')");$(".error").remove();};$("#local").validate({rules:{va_telefono:{required:true},va_horario:{required:true},va_rango_precio:{required:true},ta_dia_in_id:{required:true},pais:{required:true},departamento:{required:true},provincia:{required:true},distrito:{required:true},va_direccion:{required:true}},messages:{va_telefono:{required:"Por favor ingresar el numero telefonico"},va_razon_social:{required:"Por favor ingresar un horario"},va_rango_precio:{required:"Por favor ingresa un rango de precio"},ta_dia_in_id:{required:"Por favor ingrese dia de atencion"},va_pais:{required:"Por favor seleccione el pais"},departamento:{required:"Por favor seleccione el departamento"},provincia:{required:"Por favor seleccione la provincia"},distrito:{required:"Por favor seleccione el distrito"},va_direccion:{required:"Por favor ingrese la dirección "}},highlight:function(h){$(h).closest(".control-group").removeClass("success").addClass("error");
},success:function(h){h.text("OK!").addClass("valid").closest(".control-group").removeClass("error").addClass("success");}});$("#restaurante").validate({rules:{va_nombre:{required:true,minlength:4},va_razon_social:{required:true,minlength:10},va_web:{url:true},va_ruc:{required:true,number:true,rucReal:true},va_imagen:{required:true},Ta_tipo_comida_in_id:{required:true}},messages:{va_nombre:{required:"Por favor ingresar el nombre del restaurante",minlength:"Minimo 4 caracteres"},va_razon_social:{required:"Por favor ingresar la razon social",minlength:"Minimo 10 caractertes"},va_web:{url:"Por favor ingresa una Url valida"},va_ruc:{required:"Por favor ingrese un Ruc",number:"Por favor ingresar solo numeros",rucReal:" Ingresa un Ruc valido "},va_imagen:{required:"Por favor ingresar una imagen"},Ta_tipo_comida_in_id:{required:"Por favor ingresar un tipo de plato"}},highlight:function(h){$(h).closest(".control-group").removeClass("success").addClass("error");
},success:function(h){h.text("OK!").addClass("valid").closest(".control-group").removeClass("error").addClass("success");}});$("#platos").validate({rules:{va_nombre:{required:true,minlength:3},tx_descripcion:{required:true},va_precio:{required:true,number:true},va_imagen:{required:true},Ta_tipo_plato:{required:true}},messages:{va_nombre:{required:"Por favor ingresar el nombre del plato",minlength:"Minimo 3 caracteres"},tx_descripcion:{required:"Por favor ingresar la descripcion"},va_precio:{required:"Por favor ingrese un precio",number:"Por favor ingresar solo numeros"},va_imagen:{required:"Por favor ingresar una imagen"},Ta_tipo_plato:{required:"Por favor ingresar un tipo de plato"}},highlight:function(h){$(h).closest(".control-group").removeClass("success").addClass("error");
