...
h(b[v],null);}return false;}$(".list-suc .ul-suc li a").on("click",o);}$(document).ready(function(){$("input, textarea").placeholder();if($.browser.mozilla){$(".verlistado").css("padding-top","10px");
